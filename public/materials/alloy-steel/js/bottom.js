...
document.write(
  '<li class="fa fa-envelope-o" ><a href="mailto:estimation@ferrobend.com">estimation@ferrobend.com</a></li>'
);
document.write(
  '<li class="fa fa-phone" title="Ferrobend Phone Number">+91-836-9719424</li>'
);
document.write(
  '<li class="fa fa-home" title="Ferrobend Address">Unit #2, 109/111, Sant Sena Maharaj Marg, 2nd Kumbharwada, Goldeol, Mumbai - 400004, Maharashtra, India.</li>'
);
document.write("</ul>");
document.write('<ul class="follow-list" >');
document.write(
  '  <li><a href="https://www.facebook.com/ferrobend/" title="Ferrobend Facebook Page" target="_blank" ><i class="fa fa-facebook" aria-hidden="true"></i></a></li>'
);
document.write(
  '  <li><a href="https://www.instagram.com/ferrobend_pipe_fittings/" title="Ferrobend Instagram Page" target="_blank" ><i class="fa fa-instagram" aria-hidden="true"></i></a></li>'
);
document.write(
  '  <li><a href="https://twitter.com/ferrobend/" title="Ferrobend Twitter Page" target="_blank" ><i class="fa fa-twitter" aria-hidden="true"></i></a></li>'
);
document.write(
  '  <li><a href="https://in.linkedin.com/in/iamsamkit" title="Ferrobend Linkedin Page" target="_blank" ><i class="fa fa-linkedin" aria-hidden="true"></i></a></li>'
);

document.write(
  '  <li><a href="https://api.whatsapp.com/send?phone=+91-836-9719424" title="Ferrobend Whatsapp" target="_blank" ><i class="fa fa-whatsapp" aria-hidden="true"></i></a></li>'
);

document.write('  <li><a href="https://www.youtube.com/channel/UCOaTFXb-Cc4nV41Zb0K_WgA" title="Ferrobend Youtube Channel" target="_blank" ><i class="fa fa-youtube-play" aria-hidden="true"></i></a></li>');

document.write('  <li><a href="https://in.pinterest.com/ferrobend/" title="Ferrobend Pinterest Page" target="_blank" ><i class="fa fa-pinterest" aria-hidden="true"></i></a></li>');
...
document.write('&copy; 2017. <a href="https://ferrobend.com" target="_blank">Ferrobend</a>');
document.write("</div>");
